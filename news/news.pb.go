...
func (x *GetCategoriesParams) GetParentId() int32 {
	if x != nil {
		return x.ParentId
	}
	return 0
...
var file_news_news_proto_rawDesc = string([]byte{
	...
	0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x46, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65,
	...
	0x01, 0x28, 0x05, 0x52, 0x08, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x22, 0x57, 0x0a,
	...
	0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x22, 0x41, 0x0a, 0x1a, 0x47, 0x65, 0x74, 0x53, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x73, 0x42, 0x79, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79, 0x50, 0x61,
	0x72, 0x61, 0x6d, 0x73, 0x12, 0x23, 0x0a, 0x0d, 0x63, 0x61, 0x74, 0x65, 0x67, 0x6f, 0x72, 0x79,
	0x5f, 0x75, 0x75, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x0c, 0x63, 0x61, 0x74,
	0x65, 0x67, 0x6f, 0x72, 0x79, 0x55, 0x75, 0x69, 0x64, 0x22, 0x50, 0x0a, 0x19, 0x47, 0x65, 0x74,
...
var file_news_news_proto_msgTypes = make([]protoimpl.MessageInfo, 38)
var file_news_news_proto_goTypes = []any{
	...
	(*GetSourcesByCategoryParams)(nil), // 31: news.GetSourcesByCategoryParams
	(*GetArticlesBySourceParams)(nil),  // 32: news.GetArticlesBySourceParams
	(*GetFiltersByUserParams)(nil),     // 33: news.GetFiltersByUserParams
	(*GetArticlesByFilterParams)(nil),  // 34: news.GetArticlesByFilterParams
	(*UpdateFilterNameParams)(nil),     // 35: news.UpdateFilterNameParams
	(*SearchSourceParams)(nil),         // 36: news.SearchSourceParams
	(*UpdateFilterSourcesParams)(nil),  // 37: news.UpdateFilterSourcesParams
	(*GetArticle)(nil),                 // 38: news.GetArticle
	(*GetCategoryI10N)(nil),            // 39: news.GetCategoryI10n
	(*ActionArticle)(nil),              // 40: news.ActionArticle
	(*UpsertImageUUID)(nil),            // 41: news.UpsertImageUUID
...
var file_news_news_proto_depIdxs = []int32{
	...
	42, // 2: news.RawArticle.published_at:type_name -> google.protobuf.Timestamp
	42, // 3: news.ApiInArticle.published_at:type_name -> google.protobuf.Timestamp
	...
	42, // 14: news.ArticleMeta.published_at:type_name -> google.protobuf.Timestamp
	...
	26, // 23: news.GetCategoryI10n.data:type_name -> news.CategoryData
