...
type NormalizedArticle struct {
	...
	ImageUuid     []byte                 `protobuf:"bytes,4,opt,name=image_uuid,json=imageUuid,proto3" json:"image_uuid,omitempty"`
	SourceUuid    []byte                 `protobuf:"bytes,5,opt,name=source_uuid,json=sourceUuid,proto3" json:"source_uuid,omitempty"`
	State         int32                  `protobuf:"varint,6,opt,name=state,proto3" json:"state,omitempty"`
	Lang          int32                  `protobuf:"varint,7,opt,name=lang,proto3" json:"lang,omitempty"`
	PublishedAt   *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=published_at,json=publishedAt,proto3" json:"published_at,omitempty"`
	unknownFields protoimpl.UnknownFields
...
func (x *NormalizedArticle) GetUuid() []byte {
	if x != nil {
		return x.Uuid
	}
	return nil
...
func (x *NormalizedArticle) GetImageUuid() []byte {
	if x != nil {
		return x.ImageUuid
	}
	return nil
...
func (x *NormalizedArticle) GetSourceUuid() []byte {
	if x != nil {
		return x.SourceUuid
	}
	return nil
...
var file_news_news_proto_rawDesc = string([]byte{
	...
	0x28, 0x0c, 0x52, 0x09, 0x69, 0x6d, 0x61, 0x67, 0x65, 0x55, 0x75, 0x69, 0x64, 0x12, 0x1f, 0x0a,
	0x0b, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x75, 0x75, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x0c, 0x52, 0x0a, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x55, 0x75, 0x69, 0x64, 0x12, 0x14,
