...
var file_news_news_proto_rawDesc = string([]byte{
	...
	0x0a, 0x0a, 0x5f, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x22, 0x44, 0x0a, 0x0c,
	...
	0x6f, 0x6e, 0x22, 0x88, 0x01, 0x0a, 0x0d, 0x47, 0x65, 0x74, 0x43, 0x61, 0x74, 0x65, 0x67, 0x6f,
	0x72, 0x69, 0x65, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x6c, 0x61, 0x6e, 0x67, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x05, 0x52, 0x04, 0x6c, 0x61, 0x6e, 0x67, 0x12, 0x16, 0x0a, 0x06, 0x6f, 0x66, 0x66, 0x73,
	...
	0x01, 0x28, 0x0c, 0x52, 0x08, 0x70, 0x61, 0x72, 0x65, 0x6e, 0x74, 0x49, 0x64, 0x12, 0x2e, 0x0a,
	...
	0x4c, 0x45, 0x47, 0x52, 0x41, 0x4d, 0x10, 0x03, 0x42, 0x11, 0x5a, 0x0f, 0x78, 0x33, 0x61, 0x2e,
...
var file_news_news_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
var file_news_news_proto_goTypes = []any{
	...
	(*CategorizedPush)(nil),       // 8: news.CategorizedPush
	(*CategorizedSource)(nil),     // 9: news.CategorizedSource
	(*CategorizedArticle)(nil),    // 10: news.CategorizedArticle
	(*ArticleI10N)(nil),           // 11: news.ArticleI10n
	(*Article)(nil),               // 12: news.Article
	(*ArticleShort)(nil),          // 13: news.ArticleShort
	(*ArticleMeta)(nil),           // 14: news.ArticleMeta
	(*ArticleData)(nil),           // 15: news.ArticleData
	(*ArticleDataShort)(nil),      // 16: news.ArticleDataShort
	(*ArticleCounts)(nil),         // 17: news.ArticleCounts
	(*ArticleFlags)(nil),          // 18: news.ArticleFlags
	(*ArticleContent)(nil),        // 19: news.ArticleContent
	(*Source)(nil),                // 20: news.Source
	(*Category)(nil),              // 21: news.Category
	(*CategoryMeta)(nil),          // 22: news.CategoryMeta
	(*CategoryData)(nil),          // 23: news.CategoryData
	(*GetCategories)(nil),         // 24: news.GetCategories
	(*GetCategoryI10N)(nil),       // 25: news.GetCategoryI10n
	(*ActionArticle)(nil),         // 26: news.ActionArticle
	(*UpsertImageUUID)(nil),       // 27: news.UpsertImageUUID
...
var file_news_news_proto_depIdxs = []int32{
	...
	28, // 2: news.RawArticle.published_at:type_name -> google.protobuf.Timestamp
	28, // 3: news.ApiInArticle.published_at:type_name -> google.protobuf.Timestamp
	9,  // 4: news.CategorizedPush.source:type_name -> news.CategorizedSource
	10, // 5: news.CategorizedPush.article:type_name -> news.CategorizedArticle
	14, // 6: news.Article.meta:type_name -> news.ArticleMeta
	15, // 7: news.Article.data:type_name -> news.ArticleData
	17, // 8: news.Article.counts:type_name -> news.ArticleCounts
	18, // 9: news.Article.flags:type_name -> news.ArticleFlags
	14, // 10: news.ArticleShort.meta:type_name -> news.ArticleMeta
	16, // 11: news.ArticleShort.data:type_name -> news.ArticleDataShort
	17, // 12: news.ArticleShort.counts:type_name -> news.ArticleCounts
	18, // 13: news.ArticleShort.flags:type_name -> news.ArticleFlags
	28, // 14: news.ArticleMeta.published_at:type_name -> google.protobuf.Timestamp
	2,  // 15: news.Source.type:type_name -> news.SourceType
	22, // 16: news.Category.meta:type_name -> news.CategoryMeta
	23, // 17: news.Category.data:type_name -> news.CategoryData
	21, // 18: news.GetCategories.categories:type_name -> news.Category
	23, // 19: news.GetCategoryI10n.data:type_name -> news.CategoryData
